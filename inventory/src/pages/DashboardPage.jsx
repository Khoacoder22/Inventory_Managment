...
const DashboardPage = () => {
  ...
  // Biến lưu trữ và cài đặt dữ liệu giao dịch đã được chuyển đổi cho việc hiển thị biểu đồ
  ...
  // Chuyển đổi dữ liệu giao dịch cho biểu đồ
  const transformTransactionData = (transactions, month, year) => {
    ...
    // Khởi tạo mỗi ngày trong tháng với giá trị mặc định
    ...
    // Xử lý từng giao dịch để cộng dồn số lượng, số lượng sản phẩm và số tiền theo ngày
    transactions.forEach((transaction) => {
      const transactionDate = new Date(transaction.createdAt);
      const transactionMonth = transactionDate.getMonth() + 1;
      const transactionYear = transactionDate.getFullYear();

      // Nếu giao dịch nằm trong tháng và năm đã chọn, cộng dồn dữ liệu cho ngày
    ...
    // Chuyển đổi dữ liệu theo ngày thành mảng để tương thích với biểu đồ
